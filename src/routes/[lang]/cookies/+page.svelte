...
<div class="container-app py-12">
	<div class="max-w-2xl">
		...
		<p class="text-sm text-slate-400 mb-4">{p.lastUpdated}</p>
		<p class="text-slate-600 dark:text-slate-400 mb-8">{p.intro}</p>
		<LegalPage {lang} sections={p.sections} />
	</div>
</div>
